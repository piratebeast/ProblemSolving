...
//var fnotes = new FiveNineOneTwo();
//Console.WriteLine(fnotes);

var finttheIndexOfTheFirstOccurrenceInAString = new Find_the_Index_of_the_First_Occurrence_in_a_String();
var answer = finttheIndexOfTheFirstOccurrenceInAString.StrStr("samellhu", "ll");
Console.WriteLine(answer);